...
public class MpGenerator {
    ...
    // 项目的绝对路径
    public static final  String   outPutBaseDir      = "/Users/zhangmz/GitHub Project/duofee/Eat/eat-generator/";
    // 生成*.java 的文件路径
    public static final  String   outPutJavaModel    = outPutBaseDir + "src/main/java";
    // 需要生成的表
    public static final  String[] generatorTableName = new String[] { "t_eat_evaluate_img" };
    // 作者
    private static final String   author             = "qushengkang";
    // 去除表前缀 例如：bus_user 填入bus 生成的 user
    public static final  String[] tablePrefix        = new String[] { "t" };
    // 生成的包路径
    public static final  String   packagePath        = "com.gt.eat.generator";
    public static final  String   moduleName         = "";
    // 生成mapper.xml 文件路径
    public static final  String   generatorXmlPath   = outPutBaseDir + "src/main/java/com/gt/eat/generator/xml/";
	...
	AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
			...
			new StrategyConfig()
					...
					// 自定义 service 父类
					.setSuperServiceClass( "com.gt.eat.base.BaseService" )
					// 自定义 service 实现类父类
